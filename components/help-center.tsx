    ...
    <section className="w-full flex justify-center items-start border-b border-[rgba(55,50,47,0.12)]">
      <div className="w-full px-4 md:px-12 py-16 md:py-24 flex flex-col justify-start items-start gap-12">
              ...
              <article className="h-full p-6 border border-[rgba(55,50,47,0.12)] rounded-lg hover:shadow-lg transition-shadow cursor-pointer group">
                <div className="flex flex-col justify-between h-full gap-3">
                  <div>
                    ...
                    <h3 className="text-lg font-semibold text-[#37322F] leading-tight group-hover:text-[#2A2520] transition-colors mt-3 mb-2">
                      {article.title}
                    </h3>
        ...
        <div className="w-full p-6 md:p-8 bg-[rgba(237,233,246,0.5)] rounded-lg border border-[rgba(55,50,47,0.12)]">
          ...
          <Link href="/contact" className="inline-block px-6 py-2 bg-[#37322F] text-white text-sm font-medium rounded-full hover:bg-[#2A2520] transition-colors">
            Contact Support
          </Link>
        </div>
      </div>
    ...
    <section className="w-full flex justify-center items-start border-b border-[rgba(55,50,47,0.12)]">
      <div className="w-full max-w-[800px] px-4 md:px-8 py-16 md:py-24">
        <article className="w-full">
          <Link href="/help" className="text-sm text-[#605A57] hover:text-[#37322F] mb-6 inline-block">
            ← Back to Help Center
          </Link>
              ...
              if (section.startsWith("-") || section.includes("1.") || section.includes("2.")) {
                return (
                  <div key={idx} className="mb-6">
                    {section.split("\n").map((line, lineIdx) => (
                      <div key={lineIdx} className="mb-2 text-sm md:text-base leading-7 font-sans">
                        {line}
                      </div>
                    ))}
                  </div>
          ...
          <div className="mt-12 pt-8 border-t border-[rgba(55,50,47,0.12)]">
            ...
            <div className="flex gap-3">
              <button className="px-4 py-2 border border-[#E0DEDB] text-[#37322F] text-sm font-medium rounded hover:bg-[rgba(237,233,246,0.5)] transition-colors">
                Yes, this helped
              </button>
              <button className="px-4 py-2 border border-[#E0DEDB] text-[#37322F] text-sm font-medium rounded hover:bg-[rgba(237,233,246,0.5)] transition-colors">
                Not quite
