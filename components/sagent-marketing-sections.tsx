...
export function MarketingPageShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-full min-h-screen relative bg-[#EDE9F6] overflow-x-hidden flex flex-col justify-start items-center">
      ...
      <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] border-l border-r border-[rgba(55,50,47,0.12)]">
        <FooterSection />
      </div>
    </div>
  )
...
export function SagentHero({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <section className="self-stretch pt-20 md:pt-28 pb-12 md:pb-16 border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center gap-6">
      <div className="w-full max-w-[748px] text-center flex justify-center flex-col text-[#37322F] text-[36px] md:text-[64px] lg:text-[80px] font-normal leading-[1.1] md:leading-[1.05] font-serif px-4">
        {title}
      </div>
      <div className="w-full max-w-[560px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] text-base md:text-lg font-medium leading-7 font-sans px-4">
        {subtitle}
      </div>
    </section>
  )
  ...
  return (
    <>
      <section className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
        <div className="self-stretch px-6 md:px-12 py-8 flex flex-col justify-center items-center gap-6">
          <div className="text-center text-[#605A57] text-sm font-medium leading-5 font-sans">
            Trusted by sellers and agents across
          </div>
          <div className="w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-0 border border-[#E0DEDB]">
            {Array.from({ length: 6 }).map((_, index) => (
              <div
                key={index}
                className="h-24 flex justify-center items-center border-r border-b md:border-b-0 last:border-r-0 border-[#E0DEDB] text-[#49423D] text-sm font-medium leading-5 font-sans"
              >
                Logo {index + 1}
              </div>
            ))}
      ...
      <section className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col">
        ...
        <div className="self-stretch px-6 md:px-12 py-10 overflow-x-auto">
...
export function LegalPage({
  ...
  return (
    <>
      ...
      <section className="self-stretch px-6 md:px-12 py-12 md:py-16 flex justify-center border-b border-[rgba(55,50,47,0.12)]">
        <div className="w-full max-w-[720px] flex flex-col gap-9">
          {sections.map((section) => (
            <div key={section.title} className="flex flex-col gap-3">
              ...
              <p className="text-[#605A57] text-base font-normal leading-7 font-sans">{section.body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="w-full flex flex-col border-b border-[rgba(55,50,47,0.12)]">
        <div className="self-stretch grid grid-cols-1 md:grid-cols-3">
          {cards.map((card, index) => (
            ...
            >
              <div className="text-[#49423D] text-lg font-semibold leading-7 font-sans">{card.title}</div>
              <a href={`mailto:${card.email}`} className="text-[#605A57] text-sm font-normal leading-6 font-sans">
                {card.email}
              </a>
            </div>
          ))}
