...
export default function NotFound() {
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 bg-background">
      <div className="flex flex-col justify-center items-center gap-6 max-w-[600px]">
        ...
        <div className="w-24 h-24 bg-gradient-to-br from-white/50 to-white/20 rounded-lg flex items-center justify-center">
